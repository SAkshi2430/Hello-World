...
MainFrame = Frame(root,bg ="Powder Blue", bd=10, pady=2, width=1350, height=600, relief =RIDGE)
...
def scorekeeper():
     ...
     if (button1["text"]=="X" and button5["text"]=="X" and button9["text"]=="X"):
          ...
          button1.configure (background="light pink")
          button5.configure (background="light pink")
          button9.configure (background="light pink")
          n = float (PlayerX.get () )
          score = (n + 1)
          PlayerX.set(score)
          tkinter.messagebox.showinfo("Winner X", "You have just won a Game")
     ...
     if (button1["text"]=="X" and button4["text"]=="X" and button7["text"]=="X"):
          ...
          button1.configure (background="light blue")
          button4.configure (background="light blue")
          button7.configure (background="light blue")
          n = float (PlayerX.get () )
          score = (n + 1)
          PlayerX.set(score)
          tkinter.messagebox.showinfo("Winner X", "You have just won a Game")
